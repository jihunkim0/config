...
local utils = require "jihun.statusline.utils"
local P = require "jihun.statusline.palette"
local H = require "highlight"
local autocommands = require "utils"
  ...
  autocommands.create(
    {
      CustomStatusline = {
        ...
        {"FocusLost", "*", "let g:vim_in_focus = v:false"},
        {
          ...
          "*",
          "lua require'jihun.statusline'.colors()"
        },
        {"VimEnter", "*", "lua require'jihun.statusline'.git_updates()"},
        {
          "DirChanged",
          "*",
          "lua require'jihun.statusline'.git_toggle_updates()"
        },
        {
          "User AsyncGitJobComplete",
          "lua require'jihun.statusline'.git_updates_refresh()"
        },
        {
